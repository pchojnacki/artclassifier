...
implements Stemmer, OptionHandler {
	...
	/** the current stemmer. */
	protected transient Object m_Stemmer;
	 ...
	 *
	 * @param classname
	 *            the full classname of the stemmer
	 ...
	 *
	 * @param lineLength
	 *            the max line length, before a linefeed is inserted (0 is
	 *            unlimited)
	 * @param indention
	 *            the indention of a line
	...
	public String toString() {
		...
		result += " " + Utils.joinOptions(this.getOptions());
